<script type="text/template" id="item-row">
    <tr>
        ...
        <td>
            <%= selectUnitHtml %>
            <input data-unit-id name="raw_items[<%= num %>][unit_id]" type="hidden" />
            <input data-unit name="raw_items[<%= num %>][unit]" type="hidden" />
        </td>
        <td>
        ...
        <td class="text-center">
            <label>
                <input data-add-to-stock type="checkbox" name="raw_items[<%= num %>][add_to_stock]" value="1"/>
            </label>
        </td>
    </tr>
</script>