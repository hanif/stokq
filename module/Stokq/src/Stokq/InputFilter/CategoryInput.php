 ...
 */
class CategoryInput extends InputFilter implements ServiceLocatorAwareInterface
{
    ...
    /**
     * @param Category $existingRecord
     */
    function __construct(Category $existingRecord = null)
    {
    ...
    public function init()
    {
        $this->add([
            ...
            'validators' => [
                ...
                FormUtil::noRecordExistsValidator('name', Category::class, $this->em(), ['id' => $this->getRecordIdOrNull()]),
            ],
            'filters' => [],
        ]);
