 ...
 */
class Horizontal implements RendererInterface
{
    /**
     * @var int
     */
    ...
    public function render(Element $element)
    {
        if ($element instanceof Element\Hidden) {
            ...
            $replaces = [
                ...
                '{{elem_markup}}' => '',
                '{{elem_wrapper_class}}' => $this->options['elem_wrapper_class'],
                '{{error_messages}}' => '',
                '{{help_text}}' => '',
                '{{feedback}}' => '',
                '{{elem_id}}' => '',
